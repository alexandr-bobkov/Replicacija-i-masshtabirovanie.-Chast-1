...
- Видим, что реплицировались база  `hello_from_3308` создаваемая ранее на "Мастер 1".
...
![Скриншот созданной базы на Мастер 1](./img/7.jpg)

- Видим, что реплицировались база  `hello_from_3309` создаваемая ранее на "Мастер 2".
